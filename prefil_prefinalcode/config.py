...
WEIGHTS_EARLY = (0, 0, 0, 0, 10, 100)

# MID PHASE: Focus shifts to clustering and filling gaps.
WEIGHTS_MID   = (0, 0.0, 0.2, 0.1, 0.1, 8) #the weights are 
...
WEIGHTS_LATE  = (0.0, 0.0, 0.3, 0.1, 0.1, 0.0)

# ── Simulation ─────────────────────────────────────────────
TICK_DELAY     = 0.01   # seconds between rendered frames
